                ...
                <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl dark:shadow-blue-900/10 p-8 border border-transparent dark:border-slate-800 transition-all">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="grid sm:grid-cols-2 gap-4">
                            <div>
                                <label htmlFor="firstName" className="block text-sm font-semibold text-gray-700 dark:text-slate-300 mb-2">
                                    Prénom
                                </label>
                                <div className="relative">
                                    <User className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 dark:text-slate-500 w-5 h-5" />
                                    <input
                                        type="text"
                                        id="firstName"
                            ...
                            <div>
                                <label htmlFor="lastName" className="block text-sm font-semibold text-gray-700 dark:text-slate-300 mb-2">
                                    Nom
                                </label>
                                <div className="relative">
                                    <User className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 dark:text-slate-500 w-5 h-5" />
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-12 pr-4 py-3 border-2 border-gray-200 dark:border-slate-800 bg-transparent dark:bg-slate-950 rounded-xl focus:border-blue-500 focus:outline-none transition-colors dark:text-white font-sans"
                                    placeholder="jeandupont77"
                                    required
                                />
                            </div>
                            <p className="text-[10px] text-gray-500 dark:text-slate-400 mt-1">Ce nom sera visible par les entreprises (ex: jeandupont77).</p>
                        </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <select
                                        ...
                                        className="w-full pl-12 pr-4 py-3 border-2 border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-950 rounded-xl focus:border-blue-500 focus:outline-none transition-colors appearance-none dark:text-white font-sans"
                                        required
                                    >
                        ...
                        <div className="flex items-start">
                            <input
                                type="checkbox"
                                id="terms"
                                className="w-4 h-4 mt-1 text-blue-600 border-gray-300 dark:border-slate-800 rounded focus:ring-blue-500 bg-transparent"
                                required
                            />
                            <label htmlFor="terms" className="ml-2 text-sm text-gray-600 dark:text-slate-400">
                                J'accepte les{' '}
                                <Link href="/cgv" className="text-blue-600 hover:text-blue-700 dark:text-blue-400 font-medium font-sans">
                                    conditions générales d'utilisation
                                </Link>
                                {' '}et la{' '}
                                <Link href="/confidentialite" className="text-blue-600 hover:text-blue-700 dark:text-blue-400 font-medium font-sans">
                    ...
                    <div className="text-center mt-6">
                        <p className="text-gray-600 dark:text-slate-400">
                            ...
                            <Link href="/login" className="text-blue-600 hover:text-blue-700 dark:text-blue-400 font-semibold font-sans">
                                Connectez-vous
                            </Link>
                        </p>
                    </div>
