                ...
                <div className="grid md:grid-cols-2 gap-8 mb-8">
                    ...
                    >
                        <Link href="/register/candidat">
                            <div className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 border-2 border-transparent hover:border-blue-500 cursor-pointer group h-full">
                    ...
                    >
                        <Link href="/register/entreprise">
                            <div className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 border-2 border-transparent hover:border-cyan-500 cursor-pointer group h-full">
                                <div className="flex justify-center mb-6">
                                ...
                                <ul className="space-y-3 mb-8">
                                    {[
                                        ...
                                        <li key={index} className="flex items-start">
                                            <CheckCircle className="w-5 h-5 text-cyan-600 mr-2 mt-0.5 flex-shrink-0" />
                                            <span className="text-gray-700">{feature}</span>
                                        </li>
                                    ))}
                                </ul>
